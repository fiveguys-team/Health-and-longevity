          ...
          <ul class="text-lg leading-none text-title dark:text-white lg:flex lg:gap-[30px]">
            ...
            <li class="relative">
              ...
              <ul
                ...
                <li :class="current === '/live-test' ? 'active' : ''"><router-link to="/live-streaming"
                    class="menu-item">Live</router-link></li>
                <li :class="current === '/live-test' ? 'active' : ''"><router-link to="/live-chart"
                    class="menu-item">편성표</router-link></li>
              </ul>
            </li>
