...
export const useAuthStore = defineStore("auth", () => {
  ...
  const isAuthorized = computed(() => {
    return (requiredRoles = []) =>
      token.value && requiredRoles.includes(role.value);
  });
  ...
  const logout = () => {
    ...
    document.cookie =
      "role=; Max-Age=0; path=/; expires=Thu, 01 Jan 1970 00:00:00 GMT";
    document.cookie =
      "name=; Max-Age=0; path=/; expires=Thu, 01 Jan 1970 00:00:00 GMT";
    document.cookie =
      "id=; Max-Age=0; path=/; expires=Thu, 01 Jan 1970 00:00:00 GMT";
  };
