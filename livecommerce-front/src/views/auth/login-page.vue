        ...
        <div class="mx-auto md:mx-0 max-w-md">
          ...
          <div class="mt-7" data-aos="fade-up" data-aos-delay="200">
            ...
            <input v-model="email" @input="validateEmail"
              :class="['w-full h-12 md:h-14 bg-white dark:bg-transparent border', emailError ? 'border-red-500 focus:border-red-500' : 'border-bdr-clr focus:border-primary', 'p-4 outline-none duration-300']"
          ...
          <div class="mt-5" data-aos="fade-up" data-aos-delay="300">
            ...
            <input v-model="password" @input="validatePassword"
              :class="['w-full h-12 md:h-14 bg-white dark:bg-transparent border', passwordError ? 'border-red-500 focus:border-red-500' : 'border-bdr-clr focus:border-primary', 'p-4 outline-none duration-300 placeholder:text-xl placeholder:transform placeholder:translate-y-[10px]']"
          ...
          <div class="mt-7 flex gap-3" data-aos="fade-up" data-aos-delay="500">
            <button @click="memberLogin" class="btn btn-theme-solid flex-[0.7] h-12 md:h-14 rounded-[8px]"
              data-text="로그인"><span>로그인</span></button>
            ...
            <button @click="kakaoServerLogin"
              class="flex-[1.5] h-12 md:h-14 flex items-center justify-center p-0 bg-white shadow rounded-[8px] transition hover:shadow-md min-w-0 overflow-hidden cursor-pointer">
