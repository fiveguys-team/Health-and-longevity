            ...
            <div
                ...
                <div class="mx-auto md:mx-0 max-w-md">
                    ...
                    <div class="mt-7" data-aos="fade-up" data-aos-delay="200">
                        <label
                            class="text-base sm:text-lg font-medium leading-none mb-2.5 block dark:text-white">이름</label>
                        <input v-model="name"
                    ...
                    <div class="mt-5" data-aos="fade-up" data-aos-delay="300">
                        <label
                            class="text-base sm:text-lg font-medium leading-none mb-2.5 block dark:text-white">이메일</label>
                        <input v-model="email"
                            class="w-full h-12 md:h-14 bg-white dark:bg-transparent border border-bdr-clr focus:border-primary p-4 outline-none duration-300"
                    ...
                    <div data-aos="fade-up" data-aos-delay="600">
                        <button @click="memberCreate" class="btn btn-theme-solid mt-[15px]"
                            data-text="Register"><span>Register</span></button>
                    </div>
                    <p class="text-lg mt-[15px]" data-aos="fade-up" data-aos-delay="700">Already have an account
                        ?<router-link to="/login" class="text-primary font-medium ml-1 inline-block">Login</router-link>
                    </p>
                </div>
            </div>
        </div>
